...
import 'package:latihan_quiz/page/news_detail.dart';

class news_list extends StatefulWidget {
  const news_list({super.key});
  ...
  Widget _buildItemUser(Results newsdata) {
    return InkWell(
      onTap: () =>
        ...
        return news_detail(news: newsdata);
      })),
      child: Card(
        child: Row(
